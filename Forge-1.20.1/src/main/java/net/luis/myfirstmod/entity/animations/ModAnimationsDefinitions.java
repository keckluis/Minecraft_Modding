package net.luis.myfirstmod.entity.animations;
...
public class ModAnimationsDefinitions {
    public static final AnimationDefinition PENGUIN_IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
    ...
    public static final AnimationDefinition PENGUIN_WALK = AnimationDefinition.Builder.withLength(1.5F).looping()
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition PENGUIN_SWIM = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("torso", new AnimationChannel(AnimationChannel.Targets.ROTATION,
